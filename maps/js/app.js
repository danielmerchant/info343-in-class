...
var mapboxTiles = {
    accessToken: "pk.eyJ1IjoiZGFuaWVsbWVyY2hhbnQiLCJhIjoiY2l2bXA0aDhxMGQyazJvcG9zOGVyYmRwNiJ9.bE3xVhh_zxUxkE1_jVbaLw",
...
fetch(seattle911API)
    ...
    .then(function(data) {
        ...
        data.forEach(function(record) {
           ...
           var html = "<p> </p>";
           marker.bindPopup("<p><ul>" + "<li>" + record.address + "</li>" + "<li>" + record.type + "</li>" + "<li>" + record.datetime + "</li>" + "</ul></p>"); 
        });
    })
    .catch(function(err) {
        console.error(err);
